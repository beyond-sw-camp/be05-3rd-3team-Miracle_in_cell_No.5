                ...
                <div class="form-row">
                    ...
                    <div class="form-group anonymous-buttons">
                        ...
                        <div class="anonymous-button-group">
                            <button :class="{ active: post.anonymous === 'Realname' }" @click="setAnonymous('Realname')">닉네임 공개</button>
                            <button :class="{ active: post.anonymous === 'Anonymous' }" @click="setAnonymous('Anonymous')">닉네임 비공개</button>
                        </div>
                    </div>
                </div>
                <div class="form-group">
